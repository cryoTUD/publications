...
This repository contains all the scripts needed to reproduce the figures from the paper "[Electron scattering properties of biological macromolecules and their use for cryo-EM map sharpening](https://doi.org/10.1039/D2FD00078D)" (2022) by Alok Bharadwaj, and Arjen J. Jakobi.
