...
def launch_figure_printing(args):   
    ...
    figure_1ab_path = os.path.join(local_faraday_folder,"figure_1","Figure_1ab_plot_radial_profiles.py")
    figure_2f_path = os.path.join(local_faraday_folder,"figure_2","Figure_2f_atomic_and_guinier_bfactors.py")
    figure_2g_path = os.path.join(local_faraday_folder,"figure_2","Figure_2g_plot_local_profile.py")
    
    figure_3c_path = os.path.join(local_faraday_folder,"figure_3","Figure_3c_plot_radial_profile_perturbed_modemaps.py")
    figure_4b_path = os.path.join(local_faraday_folder,"figure_4","Figure_4b_bfactor_distribution_scattered.py")
    figure_5a_path = os.path.join(local_faraday_folder,"figure_5","Figure_5a_plot_ensemble_profiles.py")
    figure_5b_path = os.path.join(local_faraday_folder,"figure_5","Figure_5b_get_helix_sheet_violinplots.py")
    figure_5c_path = os.path.join(local_faraday_folder,"figure_5","Figure_5c_apply_average_profiles.py")
    figure_S2_path = os.path.join(local_faraday_folder,"supplements","plot_profile_fit.py")
    figure_S3_path = os.path.join(local_faraday_folder,"supplements","fsc_dip_analysis_with_rmsd.py")
