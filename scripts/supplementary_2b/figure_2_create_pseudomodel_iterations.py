...
def main():
    ...
    output_pseudomodel_structure_folder = os.path.join(output_pdbs_folder, f"figure_{figure_number}", "pseudomodel_structures_iterations_3061")
    os.makedirs(output_pseudomodel_structure_folder, exist_ok=True) 

    output_pseudomodel_map_folder = os.path.join(output_maps_folder, f"figure_{figure_number}", "pseudomodel_maps_3061")
    ...
    if SIMULATE_MAPS:
        ...
        Parallel(n_jobs=n_jobs,verbose=10)(\
            ...
            input_pdb_path, apix, emmap_shape, output_pseudomodel_map_folder, global_bfactor_map) \
