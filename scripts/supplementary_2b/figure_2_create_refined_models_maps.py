...
def main():
    ...
    output_folder = os.path.join(data_archive_path, "processed", "pdbs", f"figure_{FIGURE_NUMBER}", f"overfitting_analysis{suffix}")
    output_folder_to_store = os.path.join(data_archive_path, "processed", "structured_data", f"figure_{FIGURE_NUMBER}", f"overfitting_analysis{suffix}")
