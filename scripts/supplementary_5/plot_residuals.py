...
def main():    
    ...
    uncalibrated_residual_plot_path = os.path.join(plot_output_folder, "uncalibrated_residuals_1.pdf")
    calibrated_residual_plot_path = os.path.join(plot_output_folder, "calibrated_residuals_1.pdf")
    calibration_plot_path = os.path.join(plot_output_folder, "calibration_plot_1.pdf")
    ...
    with temporary_rcparams(rcparams):
        ...
        y_array = isotonic_regressor_v1.predict(x_array)
