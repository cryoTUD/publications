...
def main():
    ...
    # DEFINE THE PATHS 
    input_structured_data_folder = os.path.join(data_archive_path, "processed","structured_data", f"figure_{figure_number}", "overfitting_analysis_3061_unrestrained")
    output_figures_folder = os.path.join(data_archive_path, "outputs", f"figure_{figure_number}", "unrestrained_refinement_3061")
    ...
    fsc_curves_average_figure_path = os.path.join(output_figures_folder, f"figure_{figure_number}_fsc_curves_average.pdf")
    fsc_curves_average_figure_path_png = os.path.join(output_figures_folder, f"figure_{figure_number}_fsc_curves_average.png")
