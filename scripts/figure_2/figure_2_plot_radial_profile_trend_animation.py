...
def main():
    ...
    figure_output_folder = os.path.join(data_archive_path, "outputs", f"figure_{figure_number}", "animation_radial_profile")
    ...
    radial_profile_fig_path_png = os.path.join(figure_output_folder, "figure_2_radial_profiles_iteration_cycle_{}.png")
    ...
    zoom_radial_profile_fig_path_png = os.path.join(figure_output_folder, "figure_2_radial_profiles_iteration_zoom_cycle_{}.png")
    ...
    normalised_profiles_raw = [sharpened_profiles[i]/sharpened_profiles[i].max() for i in iterations]
    #normalised_profiles_raw += [radial_profiles_iterations["other_info"]["reference_normalised"]*1.3]   # 1.3 for 8702 
    legend_labels = [f"iteration {i}" for i in iterations] + ["reference"]
    # Plot the radial profiles

    for i in range(1,len(normalised_profiles_raw)+1):
        print(f"Cycle {i} of {len(normalised_profiles_raw)}")
        radial_profile_fig_path_png = os.path.join(figure_output_folder, "figure_2_radial_profiles_iteration_cycle_{}.png")
        zoom_radial_profile_fig_path_png = os.path.join(figure_output_folder, "figure_2_radial_profiles_iteration_zoom_cycle_{}.png")
        radial_profile_fig_path_png = radial_profile_fig_path_png.format(i)
        zoom_radial_profile_fig_path_png = zoom_radial_profile_fig_path_png.format(i)

        normalised_profiles = normalised_profiles_raw[:i]
        normalised_profiles += [radial_profiles_iterations["other_info"]["reference_normalised"]*1.3]   # 1.3 for 8702
