...
def main():
    ...
    for emdb_pdb in keys_present_in_both:
        ...
        corr = pearsonr(bfactor_pseudo_embd, bfactor_atomic_emdb)
        bfactor_correlation_emdb[emdb_pdb] = [corr[0], corr[1]]

    # Save to pickle
    adp_correlation_dictionary = {
        "bfactor_correlation_emdb": bfactor_correlation_emdb,
    ...
    with open(output_filename, "wb") as f:
        pickle.dump(adp_correlation_dictionary, f)
